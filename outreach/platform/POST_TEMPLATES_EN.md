# Platform Post Templates (EN)

## Template 1 — LinkedIn/X (short)
I just published an **evidence-backed pre-launch portfolio** for local/self-hosted AI ops services.
...
Built a small evidence-first service portfolio for local/self-hosted AI environments.

Common issues addressed:
- unstable integrations
- unclear failure states
- missing launch-gate clarity
